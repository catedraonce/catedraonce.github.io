...
## Premios de la Cátedra a TFGs y TFMs 2025/26

Convocatoria de la **V Edición de los Premios ONCE-UCM a los mejores trabajos de fin de Grado y Máster** que trabajen la accesibilidad y la inclusión en cualquier área de conocimiento para el Curso 2025-26 abiertos a **todas las disciplinas y áreas de conocimiento** dentro de la UCM, siempre y cuando tengan la **accesibilidad e inclusión** como eje central. 
...
* **Manuscrito** de la memoria de TFG o TFM final.

Tanto el documento de consentimiento como la memoria deberán entregarse en formato pdf.
Las propuestas se enviarán por correo electrónico a **[catedraonce@ucm.es](mailto:catedraonce@ucm.es)** hasta el **5 de octubre de 2026**. Además de la documentación, los participantes habrán de realizar una presentación pública de la propuesta.
...
Ha decidido proponer los siguientes premios a los mejores Trabajos de Fin de Grado y Máster en la convocatoria del curso 2023-24, con la relación de beneficiarios y la cuantía individualizada a conceder, conforme al acta de evaluación elaborada. 

**El acto de entrega de estos premios será el jueves 21 de noviembre a las 18:30h en la Sala de Grados de la Facultad de Informática de la UCM**.

### Trabajos de Fin de Master

|      | Alumno/s                      | Facultad                        | Título del TFM                                               | Premio |
| ---- | ----------------------------- | ------------------------------- | ------------------------------------------------------------ | ------ |
| 1º   | Jonathan Jose Jimenez Jimenez | Facultad de Informática         | Desarrollo de un sistema de ayuda visual inteligente basado en smart glasses para personas con baja visión para personas con discapacidad intelectual | 500€   |
| 2º   | Carla Otero Currás            | Facultad de Óptica y Optometría | Análisis de la función visual mediante un sistema de inteligencia artificial en personas con daño cerebral adquirido | 200€   |
| 3º   | Cristina García Pérez         | Facultad de Medicina            | La influencia de la figura del asistente personal en la calidad de vida de las personas con diversidad funcional y sus cuidadores informales | 100€   |

### Trabajos de Fin de Grado

| nº   | Alumno/s                                   | Facultad                        | Título del TFG                                               | Premio |
| ---- | ------------------------------------------ | ------------------------------- | ------------------------------------------------------------ | ------ |
| 1º   | Alba López González y Pablo Rabadán García | Facultad de Óptica y Optometría | Función Visual de Jóvenes Videojugadores                     | 500€   |
| 2º   | Marta Vicente Navarro                      | Facultad de Informática         | Desarrollo de un chatbot de apoyo a la terapia basada en reminiscencia | 200€   |
| 3º   | Luna Galván Rello                          | Facultad de Educación           | La inteligencia emocional como promotora de la inclusión     | 100€   |
