...
2. Si se añaden ficheros nuevos, hay que añadirlos con `git add [ficheros]`
2. Compilar y comprobar en local si los cambios han sido satisfactorios con la orden:
